...
model: gpt-5.3-codex
description: Subagent used by /review-parallel and /review-branch-parallel. Produces a full audit report for an orchestrator-defined scope and writes it to orchestrator-provided output paths (MD + JSON). No verification commands; write artifacts only.
---
